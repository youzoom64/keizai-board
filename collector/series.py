...
DAILY: list[Series] = [
    ...
    Series("sp500", "S&P500", "株式", "ポイント", 0,
           ("yahoo", "^GSPC"), ("fred", "SP500"), DIFF_PCT, "#ff4081", CYCLE_DAILY, "",
           "米国株500社。時価総額加重で、米国市場の実態を表す", family="為替・株・商品"),
    Series("dow", "ダウ平均", "株式", "ドル", 0,
           ("yahoo", "^DJI"), ("fred", "DJIA"), DIFF_PCT, "#ffd54f", CYCLE_DAILY, "",
           "米国株30社。日経平均と同じ株価平均型なので、日経と比べやすい",
           family="為替・株・商品"),
...
MONTHLY: list[Series] = [
    ...
    Series("cpi_all_index", "総合CPI 指数", "物価指数", "2020年=100", 1,
           ("dashboard", "0703010501010090000", "1", "1"), None,
           DIFF_PCT, "#00acc1", CYCLE_MONTHLY, "",
           "全品目・2020年=100", solid=True, family="物価（CPI）"),
    ...
    Series("cpi_core_core_index", "コアコアCPI 指数", "物価指数", "2020年=100", 1,
           ("dashboard", "0703010501010090040", "1", "1"), None,
           DIFF_PCT, "#7cb342", CYCLE_MONTHLY, "",
           "生鮮食品及びエネルギーを除く総合・2020年=100。基調的な物価", solid=True, family="物価（CPI）"),
    ...
    Series("import_price_ccy_index", "輸入物価・契約通貨 指数", "物価指数", "2020年=100", 1,
           ("dashboard", "0703060402000090010", "1", "1"), None,
           DIFF_PCT, "#e53935", CYCLE_MONTHLY, "",
           "為替を除いた現地価格・2020年=100。円建との差が円安のぶん", solid=True, family="輸入・輸出物価"),
    ...
    Series("export_price_jpy_index", "輸出物価・円建 指数", "物価指数", "2020年=100", 1,
           ("dashboard", "0703050401000090010", "1", "1"), None,
           DIFF_PCT, "#039be5", CYCLE_MONTHLY, "",
           "円ベース・2020年=100", solid=True, family="輸入・輸出物価"),
    ...
    Series("export_price_ccy_index", "輸出物価・契約通貨 指数", "物価指数", "2020年=100", 1,
           ("dashboard", "0703050402000090010", "1", "1"), None,
           DIFF_PCT, "#4dd0e1", CYCLE_MONTHLY, "",
           "契約通貨ベース・2020年=100", solid=True, family="輸入・輸出物価"),
